...
export const Element = ({ top, left, name, displayName, onClick, classes, disabled, tooltip, takes = "", outputs = "" }) => {
  ...
  const tooltipContent = () => {
    const takes_t = (takes && takes.length > 0) ? `takes: ${takes} ` : "";
...
export const DiamondImporter = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={180} left={631} name="Diamond Importer" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
export const Exporter = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={0} left={810} name="Exporter" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
export const BeltRight = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={360} left={541} name="Belt right" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
export const BeltDown = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={446} left={631} name="Belt down" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
export const BeltLeft = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={542} left={541} name="Belt left" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
export const BeltUp = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={446} left={451} name="Belt up" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
export const DiamondChipper = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={178} left={360} name="Diamond Chipper" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
export const Burner = ({displayName, onClick = () => {}, classes = "", tooltip}) => <Element top={180} left={541} name="Burner" displayName={displayName} onClick={onClick} classes={classes} tooltip={tooltip} />
